...
if ! git diff --no-ext-diff --quiet --exit-code; then
    ...
    git config --global core.sshCommand "ssh -i ${TEMP_SSH_PATH}/${KEY_FILENAME} -o IdentitiesOnly=yes -o UserKnownHostsFile=${SSH_PATH}/known_hosts" #-o StrictHostKeyChecking=no -F /dev/null"
