...
if ! git diff --no-ext-diff --quiet --exit-code; then
    ...
    git config --global core.sshCommand "ssh -o IdentitiesOnly=yes -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -i ${SSH_PATH}/${KEY_FILENAME} -F /dev/null"
